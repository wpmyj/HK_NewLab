...
{
    public partial class Region : BaseWindowNormal
    {
        public Region()
        {
            InitializeComponent();
        ...
        {
            MessageWindow mw = new MessageWindow("输入的注册码正确,系统已成功注册", "成功", MessageWindow.EButton.OK, MessageWindow.EIcon.Information);
            string str = "";
            ...
            switch (result)
            {
                case All.Class.Code.Region.ErrorList.注册码合格:
                    ...
                    break;
                default:
                    mw = new MessageWindow(str, "错误", MessageWindow.EButton.OK, MessageWindow.EIcon.Error);
                    break;
            }
